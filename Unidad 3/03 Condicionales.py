...
if media > mediana > moda:
    ...
    print("No se puede determinar un sesgo claro con los valores calculados.")
...
print ("1 para mostrar su nombre en mayúsculas")
print ("2 para minúsculas")
print ("3 para primera letra en mayúscula: ")
opcion = int(input(""))
